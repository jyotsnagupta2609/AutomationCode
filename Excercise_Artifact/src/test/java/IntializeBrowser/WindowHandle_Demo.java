...
public class WindowHandle_Demo {
	...
	public void initBrowser() {
		...
		Set<String> s1 = driver.getWindowHandles(); // To handle all new opened window
		...
		while(i1.hasNext())
		{
			...
			if(!mainWindow.equalsIgnoreCase(childWindow))
			{
				...
				driver.findElement(By.name("emailid")).sendKeys("jyotsna@123.com");
				driver.findElement(By.name("btnLogin")).click();			
				driver.close();	// Closing the Child Window.
				                       	
			}
		}
		driver.switchTo().window(mainWindow);  // Switching to Parent window i.e Main Window.
